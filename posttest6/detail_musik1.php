...
<section class="musik-detail">
    <div class="musik-image">
        <img src="https://images.primanada.com/image/cache/products/yamaha-apx500ii-white-800x800.jpg" alt="Gitar">
    </div>
    <div class="musik-info">
        <h2>GITAR</h2>
        <p><strong>Brand:</strong> Yamaha</p>
        <p><strong>Nama Model:</strong> APX 500</p>
        <p><strong>Harga:</strong> Rp. 3.000.000,00</p>
        <p><strong>Status:</strong> New</p>
        <p><strong>Jenis:</strong> Gitar</p>
        <p> <a href="form_editpemesanan.php"> <strong>Klik Disini untuk Melihat pesanan</strong> </a>
        <p>Gitar sejuta umat, masa loe gapunya??.</p>
    </div>
</section>
