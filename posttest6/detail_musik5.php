...
<body>
    ...
    <section class="musik-detail">
        <div class="musik-image">
            <img src="https://galerimusikindonesia.com/image/data/alat%20tiup%20dan%20perkusi/Cajon/Pearl%20PBC121B/cajon-pearl-primero-figured-cherry-a115025.jpg" alt="musik 2">
        </div>
        <div class="musik-info">
            <h2>CAJON</h2>
            <p><strong>Brand:</strong> Pearl Primero</p>
            <p><strong>Nama Model:</strong> Cherry</p>
            <p><strong>Harga:</strong> Rp. 3.000.000,00</p>
            <p><strong>Status:</strong> New</p>
            <p><strong>Jenis:</strong> Cajon Custom</p>
            <p> <a href="form_editpemesanan.php"> <strong>Klik Disini untuk Melihat pesanan</strong> </a>
            <p>Cocok buat tongkrongan orang kaya.</p>
        </div>
    </section>
